...
namespace REGISTERS {
inline GPIO::TYPEDEFS::t_GPIOx &r_GPIOA = *((GPIO::TYPEDEFS::t_GPIOx *)GPIO::ADDRESSES::BASE_ADDRESS_A);
inline GPIO::TYPEDEFS::t_GPIOx &r_GPIOB = *((GPIO::TYPEDEFS::t_GPIOx *)GPIO::ADDRESSES::BASE_ADDRESS_B);
inline GPIO::TYPEDEFS::t_GPIOx &r_GPIOC = *((GPIO::TYPEDEFS::t_GPIOx *)GPIO::ADDRESSES::BASE_ADDRESS_C);
inline GPIO::TYPEDEFS::t_GPIOx &r_GPIOD = *((GPIO::TYPEDEFS::t_GPIOx *)GPIO::ADDRESSES::BASE_ADDRESS_D);
inline GPIO::TYPEDEFS::t_GPIOx &r_GPIOE = *((GPIO::TYPEDEFS::t_GPIOx *)GPIO::ADDRESSES::BASE_ADDRESS_E);
inline GPIO::TYPEDEFS::t_GPIOx &r_GPIOH = *((GPIO::TYPEDEFS::t_GPIOx *)GPIO::ADDRESSES::BASE_ADDRESS_H);
} // namespace REGISTERS
